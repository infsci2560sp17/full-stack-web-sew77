...
which shows the contend in next page to make decission. Last option is a part for users sharing their loves. ![](/src/main/Landing.JPG)
...
users can uplaod the information to database and it will show on the table above. ![](/src/main/User.JPG)
